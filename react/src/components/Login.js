        ...
        <div className="_loginRegister">
            ...
            <form  onSubmit={submitForm} noValidate>
                <div className="form-control">
                    ...
                    <input className="input form-controle"  name="email" type="email" required placeholder="Enter your email" value={state.userInfo.email} onChange={onChangeValue} />
                </div>
                <div className="form-control">
            ...
            <div className="_navBtn">
                <a onClick={toggleNav}> if you don't have an account </a>
            </div>
        </div>
    );
}
